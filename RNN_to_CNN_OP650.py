...
for train, test in kfold.split(X, y):
    i=i+1
    model = Sequential()
    model.add(Conv3D(70, kernel_size=(3, 3, 3), activation='tanh', padding='same', data_format='channels_last', input_shape= (Number_of_timesteps, Number_of_particle , 8, 1)))
    model.add(MaxPooling3D(pool_size=(2, 2, 2), padding='same'))
    
    model.add(Conv3D(100, kernel_size=(2, 2, 2), activation='tanh',padding='same',  data_format='channels_last'))
    model.add(MaxPooling3D(pool_size=(2, 2, 2), padding='same'))
    
    model.add(Conv3D(720, kernel_size=(2, 2, 2), activation='tanh',padding='same',  data_format='channels_last'))
    model.add(MaxPooling3D(pool_size=(2, 2, 2), padding='same'))

    model.add(Conv3D(900, kernel_size=(2, 2, 2), activation='tanh',padding='same',  data_format='channels_last'))
    model.add(MaxPooling3D(pool_size=(2, 2, 2), padding='same'))

    model.add(Conv3D(1050, kernel_size=(2, 2, 2), activation='tanh',padding='same',  data_format='channels_last'))
    model.add(MaxPooling3D(pool_size=(2, 2, 2), padding='same'))

    model.add(Conv3D(1700, kernel_size=(2, 2, 2), activation='tanh',padding='same',  data_format='channels_last'))
    model.add(MaxPooling3D(pool_size=(2, 2, 2), padding='same'))

    model.add(Conv3D(1550, kernel_size=(2, 2, 2), activation='tanh',padding='same',  data_format='channels_last'))
    model.add(MaxPooling3D(pool_size=(2, 2, 2), padding='same'))
    ...
    for j in range (0, len(predicted_y), 25):
