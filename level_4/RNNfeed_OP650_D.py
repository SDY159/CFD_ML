...
Number_of_parameters_for_the_X = 7
...
history = model.fit(X, y, batch_size=Batch_Size, validation_split = 0.3, epochs=Epoch , verbose=0)
history
# list all data in history
os.chdir('/bigdata/wonglab/syang159/OP650_1/level_4')
...
np.savetxt('X2primeD.csv', a, fmt='%.8e', delimiter=",")
