...
ax.scatter(X,Z,Y, s = 5000000*W, c=scalarMap.to_rgba(W), label='Erosion profile')
...
cbar = plt.colorbar(scalarMap, shrink=0.7, pad=0.2, location='right', format=ticker.FuncFormatter(fmt))
cbar.ax.tick_params(labelsize=10)
cbar.ax.set_title('Erosion rate \n (kg/$m^2$·s)',fontsize=10)
...
plt.savefig('lgfs_plot_original_%i.png'%sim_num)
